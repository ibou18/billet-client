...
import young from "../../assets/envato/young.jpg";
            ...
            <div className="relative shadow-xl sm:overflow-hidden sm:rounded-2xl">
              ...
              <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                <h1 className="text-center text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
                  <span className="block text-white">Prends le controle</span>
            ...
            <div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8">
              <div className="mx-auto max-w-xl px-4 sm:px-6 lg:col-start-2 lg:mx-0 lg:max-w-none lg:py-32 lg:px-0">
                <div>
                  ...
                  <div className="mt-6">
                    <h2 className="text-3xl font-bold tracking-tight text-gray-900">
                      Mieux gérer vos évènements
                    </h2>
                    <p className="mt-4 text-lg text-gray-500">
                      Une bonne gestion d'évènement commence par le choix du
                      support de création et le partenaire de vente des billets.
                      Chez A-Tickets, nous facilitons la création, le suivi et
                      la gestion de vos évènements... Notre système est utilisé
        ...
        <div className="bg-white">
          <div className="mx-auto max-w-4xl py-16 px-4 sm:px-6 sm:py-24 lg:flex lg:max-w-7xl lg:items-center lg:justify-between lg:px-8">
            <h2 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-4xl">
              ...
              <span className="-mb-1 block bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text pb-1 text-transparent">
            ...
            <div className="mt-12 xl:mt-0">
              ...
              <form className="mt-4 sm:flex sm:max-w-md">
                ...
                <div className="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
                  <button
                    type="submit"
                    className="flex w-full items-center justify-center rounded-md border border-transparent bg-gradient-to-r from-purple-600 to-blue-600 bg-origin-border px-4 py-3 text-base font-medium text-white shadow-sm hover:from-purple-700 hover:to-blue-700"
                  >
                    Subscribe
                  </button>
                </div>
